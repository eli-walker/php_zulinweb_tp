...
<div class="fy" style=" background:url(http://0001543.ks.panguweb.cn/upfile/ads/20150804113438-369103644.jpg) center top no-repeat;">
      ...
      <div class="l_pro_t"><?php echo ($selftop); ?></div>
        <ul class="l_procon">
          ...
          <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/test/tp_pro3/index.php/Home/carlist/index/cateid/$cateid"; }else{ $url="/test/tp_pro3/index.php/Home/Ry/index/cateid/$cateid"; } ?>
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/test/tp_pro3/index.php/Home/Ry/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
		    ...
		    <ul class="case-ul">
       		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
		        <a href="/test/tp_pro3/index.php/Home/Article/index/arid/<?php echo ($vo["id"]); ?>" title="<?php echo ($vo["title"]); ?>">
		                <img src="/test/tp_pro3<?php echo ($vo["pic"]); ?>" width="245" height="184" alt="<?php echo ($vo["title"]); ?>" />

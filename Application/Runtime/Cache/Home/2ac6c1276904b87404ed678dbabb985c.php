...
<div class="fy" style=" background:url(http://0001543.ks.panguweb.cn/upfile/ads/20150804113438-369103644.jpg) center top no-repeat;">
      ...
      <div class="l_pro_t"><?php echo ($topname); ?></div>
        <ul class="l_procon">
          ...
          <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/test/tp_pro3/index.php/Home/carlist/index/cateid/$cateid"; }else{ $url="/test/tp_pro3/index.php/Home/Article/index/cateid/$cateid"; } ?>
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/test/tp_pro3/index.php/Home/Article/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
...
邮箱：<?php echo (C("EMAIL")); ?> </div>
        ...
        <div class="fyRight">
                ...
                <div class="aaleft1" >
      			...
      			<div class="title"> <span class="fl"> 主要车型</span> <span class="fr">当前位置：<a href="/test/tp_pro3/index.php" title="首页">首页</a> > 
				...
				<div class="padding25">
                    ...
                    <p class="title_s">文章作者：<?php echo ($articles["author"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;时间：<?php echo (date("Y-m-d",$articles["time"])); ?></p>
                                        <p class="center"><img src="/test/tp_pro3/<?php echo ($articles["pic"]); ?>" alt="车型：车型展示名称" /></p>
                                        <p class="pro-ri">

  ...
  <div class="fyLeft">
      ...
      <div class="l_pro_t"><?php echo ($selftop); ?></div>
        <ul class="l_procon">
          ...
          <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/test/tp_pro3/index.php/Home/carlist/index/cateid/$cateid"; }else{ $url="/test/tp_pro3/index.php/Home/Zplist/index/cateid/$cateid"; } ?>
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/test/tp_pro3/index.php/Home/Zplist/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
...
邮箱：<?php echo (C("EMAIL")); ?> </div>
  ...
  <div class="fyRight">
      ...
      <div class="hrBoxR">
        <ul>
          <li class="topline"><span class="fl"><?php echo ($vo["title"]); ?></span><a title="应聘此职位" class="fr" href="/test/tp_pro3/index.php/Home/Job/index/arid/<?php echo ($vo["id"]); ?>"><img width="90" height="26" src="/test/tp_pro3/Application/Home/Public/pc/images/re.gif"></a>
            <div class="clear"></div>
          </li>

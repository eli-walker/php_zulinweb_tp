            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/test/tp_pro3/index.php/Admin/Privilege/add" class="btn btn-primary btn2"><i class="icon-font"></i>新增权限</a>
                        <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i><input form="myform" formaction="/test/tp_pro3/index.php/Admin/Privilege/bdel" type="submit" class="btn btn-primary btn2" value="批量删除" /></a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($pris)): $i = 0; $__LIST__ = $pris;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-update" href="/test/tp_pro3/index.php/Admin/Privilege/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确定删除本权限及其子权限？');" href="/test/tp_pro3/index.php/Admin/Privilege/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>

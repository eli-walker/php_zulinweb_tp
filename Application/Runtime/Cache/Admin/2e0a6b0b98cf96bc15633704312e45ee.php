...
<div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/test/tp_pro3/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">管理员管理</span></div>
        </div>
       <!-- <div class="search-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" method="post" action="/test/tp_pro3/index.php/Admin/Admin/sort" >
                <div class="result-title">
                    <div class="result-list">
                        <a href="/test/tp_pro3/index.php/Admin/Admin/add"><i class="icon-font"></i>新增管理员</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                     ...
                     <?php if(is_array($admins)): $i = 0; $__LIST__ = $admins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td width="20%">
                                <a class="link-update" href="/test/tp_pro3/index.php/Admin/Admin/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" href="/test/tp_pro3/index.php/Admin/Admin/del/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('是否确定删除栏目？')">删除</a>
                            </td>

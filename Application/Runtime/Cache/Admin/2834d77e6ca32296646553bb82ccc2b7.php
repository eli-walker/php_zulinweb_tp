...
<div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/test/tp_pro3/index.php/Admin/Index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">求职管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <a id="batchDel" href="javascript:void(0)"><input form="myform" formaction="/test/tp_pro3/index.php/Admin/Job/bdel" type="submit" class="btn btn-primary btn2" value="批量删除" /></a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-update" href="/test/tp_pro3/index.php/Admin/Job/detail/id/<?php echo ($vo["id"]); ?>">查看</a>
                                <a class="link-del" onclick="return confirm('确定删除此求职吗？');" href="/test/tp_pro3/index.php/Admin/Job/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>

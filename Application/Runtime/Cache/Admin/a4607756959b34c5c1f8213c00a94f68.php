...
<div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/test/tp_pro3/index.php/Admin/Message/lst">留言管理</a><span class="crumb-step">&gt;</span><span>查看及回复留言</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <?php if($messages['checked'] == '1'): ?><input name="checked" type="checkbox" value="1" checked="checked" > 审核通过
                               <?php else: ?><input name="checked" type="checkbox" value="1" ><?php endif; ?>  
                                </td>
                            </tr>
                            <tr>
                                <th></th>

                        ...
                        <tbody>
	                                ...
	                                <td>
	                                   <select name="parentid">
	                                   	 <option value="0" >顶级栏目</option>
	                                   		<?php if(is_array($cates_all)): $i = 0; $__LIST__ = $cates_all;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$co): $mod = ($i % 2 );++$i;?><option value="<?php echo ($co["id"]); ?>"><?php echo (str_repeat("—",$co['level'])); echo ($co["catename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
	                                   </select>
	                                </td>
	                            <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="catename" name="keywords" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>描述：</th>
                                <td>
                                    <textarea rows="3" cols="50" name="des"></textarea> 
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>栏目类别：</th>
                                <td>
                                    <input class="common-text required"  name="type" size="50" checked="checked" value="1" type="radio">列表
                                    <input class="common-text required"  name="type" size="50" value="2" type="radio">单页
                                    <input class="common-text required"  name="type" size="50" value="3" type="radio">留言
                                    <input class="common-text required"  name="type" size="50" value="4" type="radio">招聘
                                </td>
                            </tr>
                            <tr>
                                <th>缩略图：</th>

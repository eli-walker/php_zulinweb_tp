...
<div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            <a class="crumb-name" href="/test/tp_pro3/index.php/Admin/Link/lst">链接管理</a>
            <span class="crumb-step">&gt;</span><span>修改链接</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input  name="id"  value="<?php echo ($links["id"]); ?>" type="hidden">
                            ...
                            <tr>
                                <th>链接描述：</th>
                                <td>
                                    <input class="common-text required" id="desc" name="desc" size="50" value="<?php echo ($links["desc"]); ?>" type="text">
                                </td>
                            </tr>

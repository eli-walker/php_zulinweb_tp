        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                	 <input  name="id"  value="<?php echo ($admins["id"]); ?>" type="hidden">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" name="username" size="50" value="<?php echo ($admins["username"]); ?>" type="text">
                                </td>
                            </tr>
                           ...
                           <tr>
                                ...
                                <td>
                                    <input class="common-text required" name="password" size="50" value="<?php echo ($admins["password"]); ?>" type="text">
                                </td>
                            </tr>
                             <tr>

...
<div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/test/tp_pro3/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">链接管理</span></div>
        </div>
       <!-- <div class="search-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" method="post" action="/test/tp_pro3/index.php/Admin/Link/sort" >
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                     ...
                     <?php if(is_array($links)): $i = 0; $__LIST__ = $links;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["desc"]); ?></td>
                            <td width="20%">
                                <a class="link-update" href="/test/tp_pro3/index.php/Admin/Link/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" href="/test/tp_pro3/index.php/Admin/Link/del/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('是否确定删除链接？')">删除</a>
                            </td>
